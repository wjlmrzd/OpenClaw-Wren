# Check syntax issues in flagged files
$flagged = @(
...
Write-Host ""
Write-Host "Total: $($issues.Count) files with issues"
$issues | ConvertTo-Json -Depth 3 | Out-File "memory\syntax-issues.json" -Encoding UTF8
