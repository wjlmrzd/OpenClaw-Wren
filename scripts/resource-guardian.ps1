...
$hourlyLimits = @{}
$hourlyLimits['dashscope-coding-plan/qwen3.5-plus'] = 100
$hourlyLimits['dashscope-coding-plan/qwen3-coder-plus'] = 100
$hourlyLimits['dashscope-coding-plan/qwen3-coder-next'] = 100
$hourlyLimits['dashscope-coding-plan/glm-5'] = 100
$hourlyLimits['dashscope-coding-plan/glm-4.7'] = 100
$hourlyLimits['dashscope-coding-plan/kimi-k2.5'] = 100
$hourlyLimits['dashscope-coding-plan/minimax-m2.5'] = 100
...
foreach ($model in $modelStats.Keys) {
    ...
    $quotaUsage[$model] = @{}
    $quotaUsage[$model]['requests'] = $usage
    $quotaUsage[$model]['hourlyLimit'] = $hourlyLimit
    $quotaUsage[$model]['totalQuota'] = $totalHourlyQuota
    $quotaUsage[$model]['percentage'] = $percentage
}
...
$result['hasApiWarning'] = $hasApiWarning
$result['hasMemoryWarning'] = $hasMemoryWarning
$result['hasDiskWarning'] = $hasDiskWarning
$result['severeMemoryWarning'] = $severeMemoryWarning
$result['severeDiskWarning'] = $severeDiskWarning
$result['shouldSendNotification'] = $shouldSendNotification
$result['notificationType'] = $notificationType
$result['isSilentPeriod'] = $isSilentPeriod
